...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add beer drinking</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
							...
							<div class="col-md-10" style="background-color:#F6F6F6;">
								<div class="table-responsive">
									<table class="table">
										<caption>
											<h3>Choose how much beer you drink</h3>
										</caption>
										 <?php   if ( isset($errMSG) ) {  
												?>
										...
										<tbody>
											<tr>
												<td class="col-md-2" style="vertical-align: middle">
													<img class="img-rounded img-responsive center-block" src="../../res/pic/beer.png" alt="Cinque Terre" width="50" height="50">
													<p class="text-center">BEER </p>
												</td>
												<td class="col-md-4" style="vertical-align: middle">
													
													<div class="form-group">
													 <select class="form-control" id="beertype" name="beertype">
														<option value="Full Strength">Full Strength (4.8%)</option>
														<option value="Mid Strength">Mid Strength (3.5%)</option>
														<option value="Low Strength">Low Strength (2.7%)</option>
													  </select>
														</div>
														<div class="form-group">

...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add spirits drinking</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
							...
							<div class="col-md-10" style="background-color:#F6F6F6;">
								<div class="table-responsive">
									<table class="table">
										<caption>
											<h3>Choose how much Spirits PRE-MIXED you drink</h3>
										</caption>
										 <?php   if ( isset($errMSG) ) {  
												?>
										...
										<tbody>
											<tr>
												<td class="col-md-2" style="vertical-align: middle">
													<img class="img-rounded img-responsive center-block" src="../../res/pic/glass.png" alt="Cinque Terre" width="50" height="50">
													<p class="text-center">Spirits PRE-MIXED</p>
												</td>
												<td class="col-md-4" style="vertical-align: middle">
													
													<div class="form-group">
													 <select class="form-control" id="beertype" name="beertype">
														<option value="Full strength pre-mix spirits">Full Strength (5%)</option>
														<option value="High Strength pre-mix spirits">High Strength (7%)</option>														
													  </select>
														</div>
														<div class="form-group">
